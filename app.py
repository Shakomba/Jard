...
TRANSLATIONS = {
    ...
    "ku": {
        ...
        "menu.switch_to_light": "گۆڕین بۆ دۆخی ڕووناک",
        "menu.switch_to_dark": "گۆڕین بۆ دۆخی تاریک",
        ...
        "common.add": "زیادکردن",
        "common.filter": "فیلتەر",
        "common.or": "یان",
        "common.password_placeholder": "وشەی تێپەڕ",
        "common.logo": "لۆگۆ",
        "common.saving": "هەڵگرتن...",
        ...
        "login.email_invalid": "تکایە ئیمەیڵێکی دروست بنووسە",
        "login.password_required": "وشەی تێپەڕ پێویستە",
        "login.logging_in": "چوونەژوورەوە...",
        ...
        "register.confirm_password_label": "دڵنیابوونەوەی وشەی تێپەڕ",
        "register.password_help": "بە لایەنی کەمەوە {min_len} نووسە بەکاربهێنە، کە پیت و ژمارەی تێدابێت",
        "register.password_rules_title": "مەرجەکانی وشەی تێپەڕ",
        "register.password_rule_length": "بە لایەنی کەمەوە {min_len} نووسە",
        "register.password_rule_letter": "بە لایەنی کەمەوە ١ پیت (A–Z)ـی تێدابێت",
        "register.password_rule_number": "بە لایەنی کەمەوە ١ ژمارە (0–9)ـی تێدابێت",
        "register.button": "دروستکردنی هەژمار",
        "register.creating_account": "دروستکردنی هەژمار...",
        "register.have_account": "هەژمارت هەیە؟",
        "register.name_placeholder": "ناو",
        "register.email_placeholder": "you@example.com",
        "register.password_placeholder": "********",
        "register.email_step_title": "ئیمەیڵەکەت چییە؟",
        "register.email_step_subtitle": "ئەمە بەکاردێت بۆ چوونەژوورەوە",
        "register.email_required": "تکایە ئیمەیڵەکەت بنووسە",
        "register.email_invalid": "تکایە ئیمەیڵێکی دروست بنووسە",
        "register.have_account_prefix": "هەژمارت هەیە؟",
        "register.login_link": "چوونەژوورەوە",
        "register.password_step_title": "وشەیەکی تێپەڕ دابنێ",
        "register.password_step_subtitle": "وشەیەکی تێپەڕی بەهێز هەڵبژێرە",
        "register.password_required": "تکایە وشەی تێپەڕ بنووسە",
        ...
        "register.profile_step_title": "پڕۆفایلەکەت ڕێکبخە",
        "register.profile_step_subtitle": "کەمێک دەربارەی خۆت پێمان بڵێ",
        "register.upload_photo": "وێنە زیاد بکە",
        "register.name_required": "تکایە ناوەکەت بنووسە",
        "register.complete_button": "تەواوکردن",
        ...
        "welcome.change_later_note": "دەتوانیت دواتر لە ڕێکخستنەکان بیگۆڕیت",
        "reset.request_title": "گۆڕینی وشەی تێپەڕ",
        "reset.request_help": "ئیمەیڵەکەت بنووسە بۆ ناردنی لینکی گۆڕینی وشەی تێپەڕ",
        "reset.email_label": "ئیمەیڵ",
        "reset.email_placeholder": "you@example.com",
        "reset.request_button": "ناردنی لینکی گۆڕین",
        "reset.title": "دانانی وشەی تێپەڕی نوێ",
        "reset.password_label": "وشەی تێپەڕی نوێ",
        "reset.confirm_password_label": "دڵنیابوونەوەی وشەی تێپەڕ",
        "reset.submit_button": "نوێکردنەوەی وشەی تێپەڕ",
        "email.greeting": "سڵاو",
        "email.there": "بەکارهێنەر",
        "email.button_not_working": "ئەگەر دوگمەکە کار ناکات، ئەم لینکە کۆپی بکە و لە وێبگەڕەکەتدا بیکەرەوە",
        "email.ignore_if_not_requested": "ئەگەر تۆ داوای گۆڕینی وشەی تێپەڕت نەکردووە، پشتگوێی بخە",
        "email.ignore_if_not_requested_account": "ئەگەر تۆ هەژماری Daxli264 ـت دروست نەکردووە، پشتگوێی بخە",
        "email.verify.subject": "پشتڕاستکردنەوەی ئیمەیڵی Daxli264",
        "email.verify.code_is": "کۆدی پشتڕاستکردنەوەی Daxli264 بریتییە لە",
        "email.verify.code_help": "ئەم کۆدە لە ئەپەکەدا بنووسە بۆ پشتڕاستکردنەوەی ئیمەیڵەکەت. دوای {ttl_hours} کاتژمێر کار ناکات",
        "email.reset.subject": "گۆڕینی وشەی تێپەڕی Daxli264",
        "email.reset.received_request": "داواکارییەکتان پێگەیشت بۆ گۆڕینی وشەی تێپەڕی Daxli264. ئەم لینکە دوای {ttl_minutes} خولەک کار ناکات",
        ...
        "verify.code_placeholder": "کۆد بنووسە",
        "verify.resend_button": "ناردنەوەی کۆد",
        "verify.logout_button": "چوونەدەرەوە",
        "verify.didnt_receive": "کۆدەکەت پێ نەگەیشت؟ سەیری سپام بکە یان",
        ...
        "dashboard.spending_by_person": "خەرجییەکان بەپێی کەس",
        "dashboard.household_total": "کۆی گشتی ژوور",
        ...
        "dashboard.members": "ئەندامان",
        "dashboard.since": "لە",
        "dashboard.all_settled": "هەموو باڵانسەکان پاکتاوکراون",
        "expenses.title": "خەرجییەکان",
        "expenses.add_title": "زیادکردنی خەرجی",
        "expenses.title_label": "ناونیشان",
        "expenses.title_placeholder": "نموونە: مەسرووفی ژوور",
        "expenses.amount_label": "بڕ (بە دینار)",
        "expenses.amount_help": "بە ٢٥٠ دینار زیاتر یان کەمتر دەکرێت",
        "expenses.date_label": "بەروار",
        "expenses.participants_label": "بەشداربووان",
        ...
        "expenses.filtered_by": "فیلتەرکراوە بە",
        "expenses.clear_filter": "پاککردنەوە",
        "expenses.add_first": "یەکەم خەرجیت زیاد بکە بۆ دەستپێکردن",
        "household.edit_name": "دەستکاری ناو",
        "household.name_placeholder": "ناوی ژوور",
        "household.remove_button": "لابردن",
        "household.remove_confirm": "دڵنیایت لە لابردنی {name} لە ژوورەکە؟",
        "household.join_code": "کۆدی جۆین بوون",
        "household.scan_to_join": "سکان بکە بۆ جۆین بوون",
        "household.qr_alt": "کۆدی QR بۆ جۆین بوون",
        "household.danger_zone": "ناوچەی مەترسیدار",
        "household.leave_title": "جێهێشتنی ژوور",
        "household.leave_help": "دەتوانیت ئەم ژوورە جێبهێڵیت و بچیتە ناو ژووری تر",
        "household.confirm_password": "وشەی تێپەڕ بنووسە",
        "household.leave_button": "جێهێشتنی ژوور",
        "household.leave_confirm": "دڵنیایت لە جێهێشتنی ئەم ژوورە؟",
        "household.admin_transfer_warning": "وەک ئەدمین، خاوەندارێتی دەگوازرێتەوە بۆ کۆنترین ئەندام",
        "household.removing": "لابردن...",
        "household.leaving": "جێهێشتن...",
        "setup.create_title": "دروستکردنی ژوور",
        "setup.household_name_label": "ناوی ژوور",
        "setup.household_name_placeholder": "ژوور",
        "setup.create_button": "دروستکردن",
        "setup.join_title": "چوونە ناو ژوور",
        "setup.join_code_label": "کۆدی پەیوەندیکردن",
        "setup.join_code_placeholder": "KOD",
        "setup.join_button": "چوونە ناو",
        "setup.qr_title": "چوونە ناو بە QR کۆد",
        "setup.qr_description": "ڕاستەوخۆ بە کامێرا سکانی بکە یان وێنەی QR لە گەلەری هەڵبژێرە",
        "setup.qr_scan_button": "سکانکردن بە کامێرا",
        "setup.qr_select_button": "هەڵبژاردن لە گەلەری",
        "setup.qr_modal_title": "سکانکردنی QR",
        "setup.qr_modal_subtitle": "چوونە ناو ژوور",
        "setup.qr_modal_help": "کامێراکەت ڕوو لە QR کۆدەکە بکە",
        "setup.qr_close": "داخستن",
        "setup.qr_detected": "کۆد دۆزرایەوە",
        "setup.qr_join_button": "چوونە ناو ژوور",
        "setup.qr_scan_again": "سکانکردنەوە",
        ...
        "setup.qr_status.starting_camera": "کامێرا دەکرێتەوە...",
        "setup.qr_status.camera_blocked": "ڕێگە بە کامێرا نەدراوە. مۆڵەت بدە و دووبارە هەوڵبدە",
        "setup.qr_status.camera_failed": "کامێرا کاری نەکرد. دووبارە هەوڵبدە",
        "setup.qr_status.invalid_code": "ئەم QR کۆدە هیچ ژوورێک نییە",
        "setup.qr_status.reading": "خوێندنەوەی QR...",
        "setup.qr_status.not_found": "هیچ QR کۆدێک لەم وێنەیەدا نەدۆزرایەوە. دانەیەکی تر تاقی بکەرەوە",
        "setup.qr_status.detected": "QR دۆزرایەوە. پێداچوونەوە بکە بۆ چوونە ناو",
        "setup.creating": "دروستکردن...",
        "setup.joining": "چوونەژوورەوە...",
        ...
        "archive.settle_help": "بەمە هەموو خەرجییە چالاکەکان ئەرشیف دەکرێن و باڵانسی هەمووان سفر دەکرێتەوە",
        "archive.enter_password": "وشەی تێپەڕ بنووسە",
        "archive.password_help": "بۆ ڕێگریکردن لە پاکتاوکردنی هەڵە، داوای وشەی تێپەڕ دەکەین",
        "archive.confirm_settle": "دڵنیابوونەوە لە پاکتاوکردن",
        "archive.total_archived": "کۆی گشتی ئەرشیفکراو",
        "archive.expense_count": "خەرجی",
        "archive.no_archived": "هیچ خەرجییەک ئەرشیف نەکراوە",
        "archive.danger_zone": "ناوچەی مەترسیدار",
        "archive.settle_button": "پاکتاوکردن",
        ...
        "profile.subtitle": "نوێکردنەوەی زانیارییەکان و ڕێکخستنەکان",
        ...
        "profile.upload_photo": "دانانی وێنە",
        "profile.picture_alt": "وێنەی پڕۆفایل",
        "profile.password_heading": "وشەی تێپەڕ",
        "profile.current_password": "وشەی تێپەڕی ئێستا",
        "profile.current_password_placeholder": "بەتاڵی بەجێبهێڵە ئەگەر نایگۆڕیت",
        "profile.new_password": "وشەی تێپەڕی نوێ",
        "profile.confirm_new_password": "دووبارەکردنەوەی وشەی تێپەڕی نوێ",
        "profile.password_help": "ئەگەر ناتەوێت وشەی تێپەڕ بگۆڕیت، خانەکان بە بەتاڵی بەجێبهێڵە",
        "profile.save_changes": "هەڵگرتنی گۆڕانکارییەکان",
        "profile.danger_zone": "ناوچەی مەترسیدار",
        "profile.delete_title": "سڕینەوەی هەژمار",
        "profile.delete_help": "ئەم کردارە پاشگەزبوونەوەی نییە",
        "profile.confirm_password": "دڵنیابوونەوەی وشەی تێپەڕ",
        "profile.delete_button": "سڕینەوەی هەژمار",
        "profile.delete_confirm": "دڵنیایت لە سڕینەوەی هەژمارەکەت؟ ئەم کارە گەڕانەوەی نییە",
        "profile.preferences": "ڕێکخستنەکان",
        "profile.preferences_subtitle": "زمان و ڕووکارەکەت بگۆڕە",
        ...
        "flash.invalid_join_code": "کۆدی پەیوەندیکردن هەڵەیە",
        ...
        "flash.enter_current_password": "تکایە وشەی تێپەڕی ئێستات بنووسە بۆ گۆڕینی",
        ...
        "flash.avatar_type_invalid": "جۆری وێنەکە گونجاو نییە. تکایە PNG, JPG یان WEBP بەکاربهێنە",
        "flash.profile_updated": "پڕۆفایل نوێکرایەوە",
        "flash.verification_email_sent": "کۆدی پشتڕاستکردنەوە نێردرا. تکایە ئیمەیڵەکەت بپشکنە",
        "flash.email_verified": "ئیمەیڵەکەت پشتڕاستکرایەوە",
        "flash.email_already_verified": "ئیمەیڵەکەت پێشتر پشتڕاستکراوەتەوە",
        "flash.verification_code_invalid": "ئەو کۆدە هەڵەیە",
        "flash.verification_code_expired": "کاتی ئەو کۆدە بەسەرچووە. تکایە داوای یەکێکی نوێ بکە",
        "flash.password_reset_sent": "ئەگەر ئەو ئیمەیڵە تۆمارکرابێت، لینکی گۆڕینی وشەی تێپەڕت پێ دەگات",
        ...
        "flash.household_created": "ژوور دروستکرا. کۆدی پەیوەندیکردن بدە بە هاوژوورەکانت",
        "flash.password_required": "تکایە وشەی تێپەڕ بنووسە",
        "flash.password_incorrect": "وشەی تێپەڕ هەڵەیە",
        "flash.admin_cant_leave": "ئەدمینەکان ناتوانن ژوور جێبهێڵن",
        "flash.settle_admin_only": "تەنها ئەدمینی ژوور دەتوانێت پاکتاو بکات",
        "flash.left_household": "ژوورەکەت جێهێشت",
        "flash.delete_account_blocked": "پێش سڕینەوەی هەژمار، دەبێت ئەندامەکانی تر لاببەیت یان ژوورەکە جێبهێڵیت",
        "flash.account_deleted": "هەژمارەکەت سڕایەوە",
        "flash.enter_join_code": "تکایە کۆدی پەیوەندیکردن بنووسە",
        "flash.already_in_this_household": "تۆ خۆت لەم ژوورەیت",
        "flash.switched_household": "گواسترایەوە بۆ ژووری {name}",
        "flash.admin_cant_switch": "ئەدمین ناتوانێت ژوور بگۆڕێت تا ئەندامی تری تێدا بێت",
        "flash.use_leave_household": "'جێهێشتنی ژوور' بەکاربهێنە بۆ دەرچوون",
        "flash.cant_remove_admin": "ناتوانیت ئەدمینی ژوور لاببەیت",
        ...
        "flash.household_name_updated": "ناوی ژوور نوێکرایەوە",
        "flash.title_required": "ناونیشان پێویستە",
        "flash.amount_positive": "بڕی پارە دەبێت ژمارەیەکی دروست بێت",
        "flash.select_participant": "لانیکەم بەشداربوویەک دیاری بکە",
        "flash.invalid_participants": "بەشداربووی هەڵە دیاری کراوە",
        "flash.expense_added": "خەرجی زیادکرا",
        "flash.only_payer_delete": "تەنها خاوەنی خەرجی دەتوانێت بیسڕێتەوە",
        "flash.expense_deleted": "خەرجی سڕایەوە",
        "flash.nothing_to_settle": "هیچ شتێک نییە بۆ پاکتاوکردن",
        "flash.settled_up": "پاکتاوکرا! خەرجییەکانی {month} ئەرشیفکران",
        "household.default_name": "ماڵەکەم",
    },
}
